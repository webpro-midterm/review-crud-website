<x-app-layout>
    <div class="container">
        <h1 class="text-2xl text-center">Add Movie</h1>
        <div class="flex justify-center mt-10">
            <div class="bg-[#2F4156] bg-opacity-80 text-white p-5 max-w-4xl">
                ...
                <form action="{{ route('movies.store') }}" method="POST" enctype="multipart/form-data" class="flex flex-col"> <!-- Added enctype -->
                    ...
                    <button type="submit" class="btn btn-primary bg-slate-500 max-w-fit mt-5">Add Movie</button>
                </form>
